...
function Footer() {
    return (
        <div className='footer text-center mt-3'>
                <div className='payment-methods row py-3 justify-content-center mt-8 bg-white align-items-center'>
            ...
            <div className='polices text-center py-3' >
                ...
                <div style={{width:"100%"}} className='row justify-content-center text-white align-items-center py-3' >
